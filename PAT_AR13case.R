...
for (i in 1:108) {
  entered<-PAT_AR13ROB161[i,4] #table
  label<-PAT_AR13ROB161[i,6] #table
  ...
  c<-distance[octave]
  vec[i]<-c #table
  dev_AR13ROB161<-data.frame(vec,PAT_AR13ROB161$target.note) #into data frame
  colnames(dev_AR13ROB161)<-c("c","note") 
  i=i+1
}
dev_PAT_AR13ROB161 <-dev_AR13ROB161
